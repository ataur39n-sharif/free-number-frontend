    ...
    return (
        <footer className="text-center bg-dark text-light">
            ...
            <Row className="" style={{ maxWidth: "100%" }}>
                ...
                <Col md={6}>
                    <div className="m-2">
                        <Link href='/privacy'><span style={{ cursor: "pointer" }}>All Countries List</span></Link> -
                        <Link href='/privacy'><span style={{ cursor: "pointer" }}> Blog</span></Link> -
                        <Link href='/privacy'><span style={{ cursor: "pointer" }}> Privacy Policy</span></Link> -
                        <Link href='/privacy'><span style={{ cursor: "pointer" }}> FAQs</span></Link> -
                        <Link href='/privacy'><span style={{ cursor: "pointer" }}> SiteMap</span></Link> -
                        <Link href='/privacy'><span style={{ cursor: "pointer" }}> About Us</span></Link>
